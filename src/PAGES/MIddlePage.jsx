  ...
  return (
    <section className=" mid_container">
      <div className="mid_wrap">
        <h1 className="folio">Create your cryptocurrency portfolio today.</h1>
        <h2 className="bitre">
          Coinbase has a variety of features that make it best place to start
          trading
        </h2>
        <div className="yetti">
          <div className="anhin">
            <div classname="terry">
              ...
              <div className="mid_divider">
                <h3 className="weed">Manage your portfolio</h3>
                <p className="pitch">
                ...
                <div>
                  <h5 class="liman">Recurring buys</h5>
                  <p class="donzy">
                ...
                <div class="alvin">
                  ...
                  <div>
                    <h5 class="lizzy">Vault protection</h5>
                    <p class="fry">
