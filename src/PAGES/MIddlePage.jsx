...
const MiddlePage = () => {
  return (
    <section className="manage-main-div">
      <div className="manage-inner-div">
        <h2 className="manage-portfolio">
          Create your cryptocurrency portfolio today
        </h2>
        <p className="manage-feature">
          Coinbase has a variety of features that make it the best place to
          start trading
        </p>
        <div className="overview-div">
          <div className="overview-div1-1">
            <div className="overview-f">
              ...
              <div>
                <h2 className="manage-text-head">Manage your portfolio</h2>
                <p className="manage-text-word">
            ...
            <div className="overview-f">
              <div className="overview-icons">
                <svg width="36" height="38" viewBox="0 0 36 38">
                  <g fill="none" fill-rule="evenodd">
                    ...
                    <path
                      fill="#FFF"
                      d="M4.75 34.438h26.125V11.875H4.75z"
                    ></path>
                    <path
                      fill="#1752F0"
              ...
              <div>
                <h2 className="manage-text-head">Recurring buys</h2>
                <p className="manage-text-word">
            ...
            <div className="overview-f">
              <div className="overview-icons">
                <svg width="30" height="33" viewBox="0 0 30 33" fill="none">
                  ...
                  ></path>
                  <path
                    d="M15 18.563l2.84 6.187h-5.68L15 18.562z"
                    fill="#fff"
                  ></path>
                  <path
              ...
              <div>
                <h2 className="manage-text-head">Vault protection</h2>
                <p className="manage-text-word">
            ...
            <div className="overview-f">
              ...
              <div>
                <h2 className="manage-text-head">Mobile apps</h2>
                <p className="manage-text-word">
          ...
          <div className="overview-div-1-2">
            <picture className="manage-picture">
              <img
